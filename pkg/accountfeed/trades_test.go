...
func TestOwnedFillsFromTradeFiltersToOwnedOrders(t *testing.T) {
	...
	fills := OwnedFillsFromTrade(AccountTrade{
...
func TestOwnedFillsFromTradeKeepsOwnedTakerTrade(t *testing.T) {
	fills := OwnedFillsFromTrade(AccountTrade{ID: "trade-1", TakerOrderID: "order-1", Market: "condition", AssetID: "token", Side: protocol.SideBuy, Size: "2", Price: "0.5", Outcome: "Up", Status: "CONFIRMED", TraderSide: "TAKER", Timestamp: "1000"}, "key", time.Unix(20, 0).UTC())
